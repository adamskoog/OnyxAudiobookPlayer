...
const GET_REQUEST = { method: "GET", ...BASE_REQUEST };
const POST_REQUEST = { method: "POST", ...BASE_REQUEST };
...
export const validatePin = async (id) => {
 ...
 * @param {string} token 
 */
export const serverConnectionTest = (connections, token) => {
...
export const getSections = async (baseUrl, token) => {
...
export const getSectionHubs = async (baseUrl, section, token) => {
    const localParams = {
...
export const getThumbnailUrl = (baseUrl, thumb, args) => {
    return formatUrl(`${baseUrl}${thumb}`, args);
}

export const getThumbnailTranscodeUrl = (h, w, baseUrl, thumb, token) => {
    let params = {
        width: w,
        height: h,
        minSize: 1,
...
export const getAlbumMetadata = async (baseUrl, itemId, args) => {
    const localParams = { };
    const params = { ...BASE_PARAMS, ...localParams, ...args };
...
export const scrobble = async (baseUrl, key, token) => {
    const localParams = { 
        key: key,                                   // ratingKey
        "X-Plex-Token": token,
...
export const unscrobble = async (baseUrl, key, token) => {
    const localParams = { 
        key: key,                                   // ratingKey
        "X-Plex-Token": token,
        identifier: "com.plexapp.plugins.library"
...
export const progress = async (baseUrl, args) => {
    const localParams = { 
        identifier: "com.plexapp.plugins.library"
    };
...
export const updateTimeline = async (baseUrl, args) => {
